...
function submitPost() {
  ...
  var data = {
    ...
    if (id === '') {
      ...
      // we are in edit state, need to update the post
      // create post
...
function deletePost(e) {
  ...
  if (e.target.parentElement.classList.contains('delete')) {
    ...
    if (confirm('Are you Sure?')) {
      _http.http.delete('http://localhost:3000/posts/' + id).then(function (res) {
...
var UI = function () {
  ...
  _createClass(UI, [{
    ...
    key: 'showAlert',
    value: function showAlert(message, style) {
      var _this = this;
    ...
    value: function changeFormState(type) {
      if (type === 'edit') {
        ...
        console.log(button);
        // get parent
        var cardFrom = document.querySelector('.card-form');
